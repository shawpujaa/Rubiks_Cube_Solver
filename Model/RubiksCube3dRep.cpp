...
class RubiksCube3dRep : public GenericRubiksCube {
private:
...
public:
    ...
    bool operator==(const RubiksCube3dRep &r1) const {
        for (int i = 0; i < 6; i++) {
            for (int j = 0; j < 3; j++) {
                for (int k = 0; k < 3; k++) {
    ...
    RubiksCube3dRep &operator=(const RubiksCube3dRep &r1) {
        for (int i = 0; i < 6; i++) {
            for (int j = 0; j < 3; j++) {
                for (int k = 0; k < 3; k++) {
...
struct Hash3d {
    size_t operator()(const RubiksCube3dRep &r1) const {
        string str = "";
        for (int i = 0; i < 6; i++) {
            for (int j = 0; j < 3; j++) {
                for (int k = 0; k < 3; k++) {
