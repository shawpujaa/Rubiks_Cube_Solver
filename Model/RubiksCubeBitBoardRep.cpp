...
class RubiksCubeBitBoardRep : public GenericRubiksCube {
...
public:
    ...
    bool operator==(const RubiksCubeBitBoardRep &r1) const {
        for (int i = 0; i < 6; i++) {
    ...
    RubiksCubeBitBoardRep &operator=(const RubiksCubeBitBoardRep &r1) {
        for (int i = 0; i < 6; i++) {
...
struct HashBitboard {
    size_t operator()(const RubiksCubeBitBoardRep &r1) const {
